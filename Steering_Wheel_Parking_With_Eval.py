...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction, display_man):
        ...
        #     item.append(bp)
        # self.index = None
        SensorManager(world, self.display_man, 'leftcam',self.hud, self._camera_transforms[0][0],#carla.Transform(carla.Location(x=lx, y=ly, z=lz), carla.Rotation(pitch=mp.left_pitch, yaw=mp.left_yaw)), 
        ...
        SensorManager(world, self.display_man, 'rightcam',self.hud , self._camera_transforms[1][0],#carla.Transform(carla.Location(x=rx, y=ry, z=rz), carla.Rotation(pitch=mp.right_pitch,yaw=mp.right_yaw)), 
...
def main():
    ...
    argparser.add_argument(
        ...
        metavar='H',
        default='127.0.0.2',
        help='IP of the host server (default: 127.0.0.2)')
    argparser.add_argument(
        '-p', '--port',
        metavar='P',
        default=2000,
